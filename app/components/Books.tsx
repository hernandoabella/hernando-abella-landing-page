    ...
    <div className="space-y-1 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
      {categoryKeys.map((cat) => (
        <button
          ...
          className={`group w-full flex items-center justify-between px-4 py-2.5 rounded-xl text-[12px] font-bold transition-all duration-200 ${
        ...
        >
          ...
          <span className={`text-[9px] font-black min-w-[18px] h-[18px] flex items-center justify-center rounded-md ${
            selectedCategory === cat 
