      ...
      <div className="container flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="relative w-full md:w-1/2 flex justify-center md:justify-end">
          <div className="relative w-[300px] sm:w-[400px] md:w-[500px] h-[300px] sm:h-[400px] md:h-[500px] flex items-center justify-center">
            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-green-700 via-green-800 to-green-900">
              {/* Icons Container */}
              <div className="grid grid-cols-4 gap-10 justify-items-center items-center">
                ...
                <i className="devicon-java-plain text-5xl sm:text-6xl text-green-500 hover:text-green-300 transition duration-300 ease-in-out transform hover:scale-125" />
                <i className="devicon-csharp-plain text-5xl sm:text-6xl text-green-500 hover:text-green-300 transition duration-300 ease-in-out transform hover:scale-125" />
                ...
                <i className="devicon-firebase-plain text-5xl sm:text-6xl text-green-500 hover:text-green-300 transition duration-300 ease-in-out transform hover:scale-125" />
